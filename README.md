...
| 🖼️ **High-Resolution Export** | Download a **300 DPI print-ready PNG**, processed securely and instantly in your browser (Client-Side). |
| 🌌 **Immersive UI** | A fully responsive, galaxy-themed interface designed for a comfortable and engaging user experience. |
| ⚡ **SEO Optimized** | Built with full JSON-LD Schema, meta tags, and semantic HTML structure for maximum search engine visibility. |
...
| :--- | :--- |
| **React 18** | Powers the interactive and component-based user interface. |
...
| **SVG** | Serves as the core rendering engine for the card preview. |
| **HTML Canvas** | Used as the export engine to convert the final SVG design into a high-resolution PNG. |
...
/
├── public/
│   ├── templates/        # SVG template assets
│   ├── favicon.svg       # Site Icon
│   ├── robots.txt        # SEO Crawler instructions
│   └── sitemap.xml       # SEO Sitemap
├── src/
│   ├── components/       # Reusable React components (Layout, CardTool, Modal, etc.)
│   ├── services/         # Business logic (e.g., DesignExporter)
│   ├── utils/            # Helpers (DesignMath, SeoArticle)
